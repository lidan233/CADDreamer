...
class Decoder(nn.Module):
    ...
    def forward(self, z, latent_embeds=None):
        ...
        last_sample = self.conv_act(sample)
        out_sample = self.conv_out(last_sample)

        return out_sample, last_sample
...
class ClassifyMLP(nn.Module):
    def __init__(self, input_size, hidden_size, num_classes):
        ...
        self.fc2 = nn.Linear(hidden_size, num_classes)  # 全连接层2，输出类别数
